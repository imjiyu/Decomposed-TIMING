...
NPY_PATTERNS = {
    ...
    "boiler": (
        "boiler_state_timing_td_trend_kalman_seg50_min1_max36_rsd_result_{fold}_42.npy",
        "boiler_state_timing_td_residual_kalman_seg50_min1_max36_rsd_result_{fold}_42.npy",
        "boiler_state_timing_td_trend_signed_kalman_seg50_min1_max36_rsd_result_{fold}_42.npy",
        "boiler_state_timing_td_residual_signed_kalman_seg50_min1_max36_rsd_result_{fold}_42.npy",
    ),
    "epilepsy": (
...
def plot_mean_heatmap(mean_trend, mean_resid, channel_indices,
    ...
    fig.subplots_adjust(
        top=top_margin, bottom=0.16, left=0.04, right=0.96, wspace=0.05, hspace=0.45,)
...
def main():
    ...
    p.add_argument("--topk_channels", type=int, default=5,
