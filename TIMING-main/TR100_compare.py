...
abs_eval_dir  = Path("results_residual_first") ### 경로 수정

raw_out_path   = Path("results_table_rsd/result_compare_raw.csv") ### 경로 수정
round_out_path = Path("results_table_rsd/result_compare.csv") ### 경로 수정
