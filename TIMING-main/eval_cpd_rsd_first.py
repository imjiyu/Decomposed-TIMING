"""
Residual first ver. 실험하기! -> cpd만 뽑자 
"""
import argparse
import csv
import os
...
def main():
    ...
    p.add_argument("--npy_dir", default="results_residual_first")
    p.add_argument("--output_file", default="results_residual_first/full_eval.csv")
